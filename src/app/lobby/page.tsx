...
export default function LobbyPage() {
  ...
  return (
    <AppFrame>
      ...
      <section className="mt-5 panel-strong rounded-[2rem] p-5 md:p-6">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          {difficulties.map((difficulty) => (
            <Link
              ...
              className="group rounded-[1.45rem] border border-[var(--line)] bg-white/84 px-4 py-4 transition hover:-translate-y-0.5 hover:border-[var(--sun)] hover:bg-white"
            >
